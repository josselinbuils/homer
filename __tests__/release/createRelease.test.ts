...
describe('release > createRelease', () => {
  ...
  it('should create a release whereas main pipeline is ready', async () => {
      ...
      view: {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: {
              text: '•   <http://gitlab.example.com/my-group/my-project/merge_requests/1|feat(great): implement great feature> - <https://manomano.atlassian.net/browse/SPAR-156|SPAR-156>\n•   <http://gitlab.example.com/my-group/my-project/merge_requests/1|feat(great): implement another great feature> - <https://manomano.atlassian.net/browse/SPAR-158|SPAR-158>\n',
              type: 'mrkdwn',
            },
            type: 'section',
          },
    ...
    expect(releaseCallMock.calledWith?.[1]).toEqual({
      body: `{"description":"- [feat(great): implement great feature](http://gitlab.example.com/my-group/my-project/merge_requests/1) - [SPAR-156](https://manomano.atlassian.net/browse/SPAR-156)\\n- [feat(great): implement another great feature](http://gitlab.example.com/my-group/my-project/merge_requests/1) - [SPAR-158](https://manomano.atlassian.net/browse/SPAR-158)","tag_name":"${releaseTagName}","ref":"${pipelineFixture.sha}"}`,
...
  •   <http://gitlab.example.com/my-group/my-project/merge_requests/1|feat(great): implement great feature> - <https://manomano.atlassian.net/browse/SPAR-156|SPAR-156>
  •   <http://gitlab.example.com/my-group/my-project/merge_requests/1|feat(great): implement another great feature> - <https://manomano.atlassian.net/browse/SPAR-158|SPAR-158>`,
            type: 'mrkdwn',
          },
          type: 'section',
...
wait for them and start the release automatically (<${pipelineFixture.web_url}|pipeline>) :homer-donut:`,
  ...
  it('should answer with an error message if command was not launched on the right channel', async () => {
    ...
    expect(await response.text()).toMatch(
      'The release command cannot be used in this channel because it has not been set up (or not correctly) in the config file, please follow the <https://git.manomano.tech/tools/homer#configure-homer-to-release-a-gitlab-project|corresponding documentation> :homer-donut:'
    );
  });
});
